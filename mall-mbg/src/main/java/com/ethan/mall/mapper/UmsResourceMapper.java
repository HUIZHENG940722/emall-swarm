...
public interface UmsResourceMapper {
    ...
    List<UmsResource> selectByExampleWithBLOBs(UmsResourceExample example);
    ...
    int updateByExampleWithBLOBs(@Param("record") UmsResource record, @Param("example") UmsResourceExample example);

    int updateByExample(@Param("record") UmsResource record, @Param("example") UmsResourceExample example);

    int updateByPrimaryKeySelective(UmsResource record);

    int updateByPrimaryKeyWithBLOBs(UmsResource record);
